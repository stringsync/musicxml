...
import { HarmonClosed } from './HarmonClosed';
 ...
 */
export type HarmonMute = ReturnType<typeof HarmonMute>;

export const HarmonMute = xml.element(
  'harmon-mute',
  {
    attributes: {
      /**
    ...
    content: [t.required(HarmonClosed)] as const,
  },
  {}
);
