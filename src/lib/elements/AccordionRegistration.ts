...
import { AccordionLow } from './AccordionLow';
 ...
 */
export type AccordionRegistration = ReturnType<typeof AccordionRegistration>;

export const AccordionRegistration = xml.element(
  'accordion-registration',
  {
    ...
    content: [t.optional(AccordionHigh), t.optional(AccordionMiddle), t.optional(AccordionLow)] as const,
  },
  {}
);
