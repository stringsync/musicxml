 ...
 */
export type StaffTuning = ReturnType<typeof StaffTuning>;

export const StaffTuning = xml.element(
  'staff-tuning',
  {
    attributes: {
      /**
    ...
    content: [t.required(TuningStep), t.optional(TuningAlter), t.required(TuningOctave)] as const,
  },
  {}
);
