...
import { HoleClosed } from './HoleClosed';
import { HoleShape } from './HoleShape';
 ...
 */
export type Hole = ReturnType<typeof Hole>;

export const Hole = xml.element(
  'hole',
  {
    attributes: {
      /**
    ...
    content: [t.optional(HoleType), t.required(HoleClosed), t.optional(HoleShape)] as const,
  },
  {}
);
